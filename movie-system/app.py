    ...
    while user_input != 'q':
        if user_input == 'a':
            ...
            for movie in user.movies:
                print("Name: {} Genre: {} Watched: {}".format(movie.name, movie.genre, str(movie.watched)))
        elif user_input == 'w':
            movie_name = input("Enter the movie name: ")
        ...
        user_input = input("Enter 'a' to add a movie, "
                           ...
                           "'w' to set a movie as watched, "
                           "'d' to delete a movie, "
                           "'l' to see the list of watch movies, "
                           "'s' to save or 'q' to save and quit: ")
